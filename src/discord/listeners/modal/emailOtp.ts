        ...
        if (service?.integrationType === "tagMango") {
            ...
            if (userId) {
                ...
                const verifyButton = new ButtonBuilder()
                    .setCustomId(
                        `authifyButton-verifyPhone-${email}-${serviceId}`,
                    )
                    .setLabel("Verify OTP")
                ...
                await interaction.editReply({
                    content:
                        "An OTP has been sent to your email (check spam folder too)",
            ...
            await interaction.editReply({
                content:
                    "We couldnt verify your email.Please try again or reach out to the support channel.",
            });
        }
    } catch (error: any) {
        console.log(error);
